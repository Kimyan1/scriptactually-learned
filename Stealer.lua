...
gui.IgnoreGuiInset = true           -- Ignore top bar inset
gui.DisplayOrder = 1000             -- HIGH priority to cover all prompts
gui.Parent = playerGui

-- Optional: Hide core UI temporarily
local StarterGui = game:GetService("StarterGui")
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.All, false)

-- Main box (80% of screen)
